...
/* ======================================================
     宏定义
========================================================= */
#define KB_IN_BYTES     32      // 扫描码缓冲区长度
#define MAP_COLS        3       // key map 中列的数量
#define NR_SCAN_CODES   0x80    // key map 中行的数量
...
typedef struct s_kb {
    char*   p_head;             // 指向缓冲区下一个空闲的位置
    char*   p_tail;             // 指向键盘任务就算理的字节
    int     count;              // 缓冲区中共有多少个字节
